      ...
      <div className="flex justify-between">
        ...
        <div className="flex space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <a href="/lists" className="py-5 px-3 text-gray-700 hover:text-gray-900">Game Lists</a>
            <a href="/minis" className="py-5 px-3 text-gray-700 hover:text-gray-900">Minis</a>
          </div>
        </div>
